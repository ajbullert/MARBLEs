...
#   tukey_hsd()
  ...
  d <- ggplot(b, aes(factor(Treatment), count))+
    geom_violin(mapping = aes(x = Treatment, y = count, fill = Treatment))+
    #adding jitter to avoid overplotting
  geom_point(mapping = aes(x = Treatment, y = count, fill = Treatment, shape= Treatment), 
  ...
  stat_summary(mapping = aes(x = Treatment, y = count), 
               geom = 'crossbar', fun= 'mean', colour = 'black', width=0.2)+
...
ggexport(
  ...
  ncol = 1, nrow = 2, height = 7, width = 7, res = 600,pointsize = 8
)
```
